	...
	testcases := []testCase{
		{
			...
			expectSelect: []string{"o-9q9-caltrain", "o-unknown-c~tran", "o-9q9-bayarearapidtransit", "o-dhv-hillsborougharearegionaltransit", "o-dqcj-wmata", "o-9qs-demotransitauthority"},
		},
		{
...
func TestOperatorRequest_License(t *testing.T) {
	testcases := []testCase{
		...
		},
		{
			...
			selector:     "operators.#.onestop_id",
			expectSelect: []string{"o-9q9-bayarearapidtransit", "o-9q9-caltrain", "o-unknown-c~tran", "o-dhv-hillsborougharearegionaltransit", "o-dqcj-wmata", "o-9qs-demotransitauthority"},
		},
		{
