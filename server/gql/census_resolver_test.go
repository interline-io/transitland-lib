...
func TestCensusResolver(t *testing.T) {
	...
	testcases := []testcase{
		...
		{
			name:              "census_datasets values basic query",
			query:             `query { census_datasets(where:{name:"acsdt5y2022"}) { values(first:10) { edges { node { geoid dataset_name source_name values } } pageInfo { hasNextPage endCursor } } } }`,
			vars:              vars,
			selectExpectCount: 10,
			selector:          "census_datasets.0.values.edges.#.node.geoid",
		},
		{
			name:              "census_datasets values filter by table",
			query:             `query { census_datasets(where:{name:"acsdt5y2022"}) { values(first:50, where:{table:"b01001"}) { edges { node { geoid dataset_name values table { table_name } } } pageInfo { hasNextPage } } } }`,
			vars:              vars,
			selector:          "census_datasets.0.values.edges.#.node.table.table_name",
			selectExpectCount: 50,
			f: func(t *testing.T, jj string) {
				tables := gjson.Get(jj, "census_datasets.0.values.edges.#.node.table.table_name").Array()
		...
		{
			name:   "census_datasets values filter by exact geoid - county",
			query:  `query { census_datasets(where:{name:"acsdt5y2022"}) { values(where:{geoid:"0500000US06001"}) { edges { node { geoid dataset_name source_name values } } pageInfo { hasNextPage } } } }`,
			vars:   vars,
			expect: `{"census_datasets":[{"values":{"edges":[{"node":{"dataset_name":"acsdt5y2022","geoid":"0500000US06001","source_name":"acsdt5y2022-b01001.dat","values":{"b01001_001":1663823,"b01001_002":826561,"b01001_003":45925,"b01001_004":47576,"b01001_005":48382,"b01001_006":28544,"b01001_007":20330,"b01001_008":10059,"b01001_009":9868,"b01001_010":28353,"b01001_011":62380,"b01001_012":72338,"b01001_013":69473,"b01001_014":62112,"b01001_015":57592,"b01001_016":55360,"b01001_017":52792,"b01001_018":20592,"b01001_019":27469,"b01001_020":16861,"b01001_021":19794,"b01001_022":30165,"b01001_023":17775,"b01001_024":12014,"b01001_025":10807,"b01001_026":837262,"b01001_027":44062,"b01001_028":44832,"b01001_029":46225,"b01001_030":27281,"b01001_031":20424,"b01001_032":9802,"b01001_033":10241,"b01001_034":28031,"b01001_035":61402,"b01001_036":70642,"b01001_037":67277,"b01001_038":59739,"b01001_039":55980,"b01001_040":53250,"b01001_041":53257,"b01001_042":21514,"b01001_043":27480,"b01001_044":17165,"b01001_045":23991,"b01001_046":35310,"b01001_047":23707,"b01001_048":15582,"b01001_049":20068}}}],"pageInfo":{"hasNextPage":false}}}]}`,
		},
		{
			name:   "census_datasets values filter by exact geoid - tract",
			query:  `query { census_datasets(where:{name:"acsdt5y2022"}) { values(where:{geoid:"1400000US06001403000"}) { edges { node { geoid dataset_name source_name values } } pageInfo { hasNextPage } } } }`,
			vars:   vars,
			expect: `{"census_datasets":[{"values":{"edges":[{"node":{"dataset_name":"acsdt5y2022","geoid":"1400000US06001403000","source_name":"acsdt5y2022-b01001.dat","values":{"b01001_001":4758,"b01001_002":1875,"b01001_003":75,"b01001_004":37,"b01001_005":100,"b01001_006":8,"b01001_007":40,"b01001_008":0,"b01001_009":0,"b01001_010":133,"b01001_011":275,"b01001_012":113,"b01001_013":325,"b01001_014":174,"b01001_015":162,"b01001_016":96,"b01001_017":94,"b01001_018":35,"b01001_019":27,"b01001_020":29,"b01001_021":31,"b01001_022":93,"b01001_023":21,"b01001_024":0,"b01001_025":7,"b01001_026":2883,"b01001_027":216,"b01001_028":123,"b01001_029":203,"b01001_030":74,"b01001_031":34,"b01001_032":0,"b01001_033":17,"b01001_034":6,"b01001_035":429,"b01001_036":258,"b01001_037":320,"b01001_038":137,"b01001_039":243,"b01001_040":167,"b01001_041":222,"b01001_042":32,"b01001_043":108,"b01001_044":10,"b01001_045":60,"b01001_046":45,"b01001_047":91,"b01001_048":20,"b01001_049":68}}}],"pageInfo":{"hasNextPage":false}}}]}`,
		},
		{
			name:         "census_datasets values filter by geoid_prefix - tract prefix",
			query:        `query { census_datasets(where:{name:"acsdt5y2022"}) { values(first:20, where:{geoid_prefix:"1400000US0600140"}) { edges { node { geoid dataset_name values } } pageInfo { hasNextPage endCursor } } } }`,
			vars:         vars,
			selector:     "census_datasets.0.values.edges.#.node.geoid",
		...
		{
			name:              "census_datasets values filter by geoid_prefix - county prefix",
			query:             `query { census_datasets(where:{name:"acsdt5y2022"}) { values(first:10, where:{geoid_prefix:"0500000US"}) { edges { node { geoid dataset_name values } } pageInfo { hasNextPage } } } }`,
			vars:              vars,
			selector:          "census_datasets.0.values.edges.#.node.geoid",
			selectExpectCount: 2,
		...
		{
			name:   "census_datasets values combined filters - all filters",
			query:  `query { census_datasets(where:{name:"acsdt5y2022"}) { values(where:{table:"b01001", geoid:"1400000US06001403000"}) { edges { node { geoid dataset_name source_name values table { table_name } } } pageInfo { hasNextPage } } } }`,
			vars:   vars,
			expect: `{"census_datasets":[{"values":{"edges":[{"node":{"dataset_name":"acsdt5y2022","geoid":"1400000US06001403000","source_name":"acsdt5y2022-b01001.dat","table":{"table_name":"b01001"},"values":{"b01001_001":4758,"b01001_002":1875,"b01001_003":75,"b01001_004":37,"b01001_005":100,"b01001_006":8,"b01001_007":40,"b01001_008":0,"b01001_009":0,"b01001_010":133,"b01001_011":275,"b01001_012":113,"b01001_013":325,"b01001_014":174,"b01001_015":162,"b01001_016":96,"b01001_017":94,"b01001_018":35,"b01001_019":27,"b01001_020":29,"b01001_021":31,"b01001_022":93,"b01001_023":21,"b01001_024":0,"b01001_025":7,"b01001_026":2883,"b01001_027":216,"b01001_028":123,"b01001_029":203,"b01001_030":74,"b01001_031":34,"b01001_032":0,"b01001_033":17,"b01001_034":6,"b01001_035":429,"b01001_036":258,"b01001_037":320,"b01001_038":137,"b01001_039":243,"b01001_040":167,"b01001_041":222,"b01001_042":32,"b01001_043":108,"b01001_044":10,"b01001_045":60,"b01001_046":45,"b01001_047":91,"b01001_048":20,"b01001_049":68}}}],"pageInfo":{"hasNextPage":false}}}]}`,
		},
		{
			name:   "census_datasets values no results with non-existent geoid",
			query:  `query { census_datasets(where:{name:"acsdt5y2022"}) { values(where:{geoid:"9999999999999"}) { edges { node { geoid dataset_name values } } pageInfo { hasNextPage } } } }`,
			vars:   vars,
			expect: `{"census_datasets":[{"values":{"edges":[],"pageInfo":{"hasNextPage":false}}}]}`,
		},
		{
			name:   "census_datasets values no results with non-existent table",
			query:  `query { census_datasets(where:{name:"acsdt5y2022"}) { values(where:{table:"nonexistent"}) { edges { node { geoid dataset_name values } } pageInfo { hasNextPage } } } }`,
			vars:   vars,
			expect: `{"census_datasets":[{"values":{"edges":[],"pageInfo":{"hasNextPage":false}}}]}`,
		},
		{
			name:  "census_datasets values pagination test",
			query: `query { census_datasets(where:{name:"acsdt5y2022"}) { values(first:5, where:{geoid_prefix:"1400000US0600140"}) { edges { node { geoid } cursor } pageInfo { hasNextPage endCursor } } } }`,
			vars:  vars,
			f: func(t *testing.T, jj string) {
				hasNextPage := gjson.Get(jj, "census_datasets.0.values.pageInfo.hasNextPage").Bool()
				endCursor := gjson.Get(jj, "census_datasets.0.values.pageInfo.endCursor").String()
				assert.True(t, hasNextPage, "should have next page")
				assert.NotEmpty(t, endCursor, "should have end cursor")
				edges := gjson.Get(jj, "census_datasets.0.values.edges").Array()
