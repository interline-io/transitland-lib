...
func TestCensusResolver(t *testing.T) {
	...
	testcases := []testcase{
		...
		// Census values tests
		{
			...
			query:             `query { census_values(limit:10) { geoid dataset_name source_name values } }`,
			vars:              vars,
			selectExpectCount: 10,
			selector:          "census_values.#.geoid",
		},
		{
			name:              "census_values filter by dataset",
			query:             `query { census_values(limit:100, where:{dataset:"acsdt5y2022"}) { geoid dataset_name source_name values } }`,
			vars:              vars,
			selector:          "census_values.#.dataset_name",
			selectExpectCount: 100,
			f: func(t *testing.T, jj string) {
				datasets := gjson.Get(jj, "census_values.#.dataset_name").Array()
		...
		},
		{
			...
			query:             `query { census_values(limit:50, where:{table:"b01001"}) { geoid dataset_name values table { table_name } } }`,
			vars:              vars,
			selector:          "census_values.#.table.table_name",
			selectExpectCount: 50,
			f: func(t *testing.T, jj string) {
				tables := gjson.Get(jj, "census_values.#.table.table_name").Array()
		...
		},
		{
			...
			query:             `query { census_values(limit:10, where:{geoid_prefix:"0500000US"}) { geoid dataset_name values } }`,
			vars:              vars,
			selector:          "census_values.#.geoid",
			selectExpectCount: 2,
		...
		},
		{
			...
			query:  `query { census_values(where:{dataset:"acsdt5y2022", table:"b01001", geoid:"1400000US06001403000"}) { geoid dataset_name source_name values table { table_name } } }`,
			vars:   vars,
			expect: `{"census_values":[{"dataset_name":"acsdt5y2022","geoid":"1400000US06001403000","source_name":"acsdt5y2022-b01001.dat","table":{"table_name":"b01001"},"values":{"b01001_001":4758,"b01001_002":1875,"b01001_003":75,"b01001_004":37,"b01001_005":100,"b01001_006":8,"b01001_007":40,"b01001_008":0,"b01001_009":0,"b01001_010":133,"b01001_011":275,"b01001_012":113,"b01001_013":325,"b01001_014":174,"b01001_015":162,"b01001_016":96,"b01001_017":94,"b01001_018":35,"b01001_019":27,"b01001_020":29,"b01001_021":31,"b01001_022":93,"b01001_023":21,"b01001_024":0,"b01001_025":7,"b01001_026":2883,"b01001_027":216,"b01001_028":123,"b01001_029":203,"b01001_030":74,"b01001_031":34,"b01001_032":0,"b01001_033":17,"b01001_034":6,"b01001_035":429,"b01001_036":258,"b01001_037":320,"b01001_038":137,"b01001_039":243,"b01001_040":167,"b01001_041":222,"b01001_042":32,"b01001_043":108,"b01001_044":10,"b01001_045":60,"b01001_046":45,"b01001_047":91,"b01001_048":20,"b01001_049":68}}]}`,
		},
		{
			name:   "census_values no results with non-existent geoid",
			query:  `query { census_values(where:{geoid:"9999999999999"}) { geoid dataset_name values } }`,
			vars:   vars,
			expect: `{"census_values":[]}`,
		},
		{
			name:   "census_values no results with non-existent table",
			query:  `query { census_values(where:{table:"nonexistent"}) { geoid dataset_name values } }`,
			vars:   vars,
			expect: `{"census_values":[]}`,
		},
	}
