...
func TestOperatorResolver_License(t *testing.T) {
	...
	testcases := []testcase{
		...
		},
		{
			...
			selector:           selector,
			selectExpectUnique: []string{"o-unknown-hopelinktransportation", "o-9q9-bayarearapidtransit"},
			selectExpectCount:  2,
		},
		{
			...
			selector:           selector,
			selectExpectUnique: []string{"o-9q9-caltrain", "o-dhv-hillsborougharearegionaltransit", "o-9qs-demotransitauthority", "o-unknown-c~tran"},
			selectExpectCount:  4,
		},
