...
func (ent *Attribution) Errors() (errs []error) {
	...
	errs = append(errs, enum.CheckPresent("organization_name", ent.OrganizationName.Val)...)
	errs = append(errs, enum.CheckURL("attribution_url", ent.AttributionURL.Val)...)
	errs = append(errs, enum.CheckInsideRangeInt("is_producer", ent.IsProducer.Val, 0, 1)...)
	errs = append(errs, enum.CheckInsideRangeInt("is_operator", ent.IsOperator.Val, 0, 1)...)
	errs = append(errs, enum.CheckInsideRangeInt("is_authority", ent.IsAuthority.Val, 0, 1)...)
	errs = append(errs, enum.CheckEmail("attribution_email", ent.AttributionEmail.Val)...)
