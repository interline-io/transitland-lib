...
type Frequency struct {
	...
	StartTime   WideTime `csv:"start_time,required" required:"true"`
	EndTime     WideTime `csv:"end_time,required" required:"true"`
	HeadwaySecs int      `csv:"headway_secs,required" required:"true"`
