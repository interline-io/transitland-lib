...
func (ent *StopTime) Errors() []error {
	...
	errs = append(errs, enum.CheckInsideRangeInt("pickup_type", ent.PickupType.Val, 0, 3)...)
	errs = append(errs, enum.CheckInsideRangeInt("drop_off_type", ent.DropOffType.Val, 0, 3)...)
	errs = append(errs, enum.CheckPositive("shape_dist_traveled", ent.ShapeDistTraveled.Val)...)
	errs = append(errs, enum.CheckInsideRangeInt("timepoint", ent.Timepoint.Val, -1, 1)...)
