...
// ExpectEntities contains information about the number and types of identities expected in a Reader.
type ExpectEntities struct {
	URL                string
	AgencyCount        int
	RouteCount         int
	TripCount          int
...
// CheckExpectEntities evalutes a Reader & Expect.
func CheckExpectEntities(t *testing.T, fe ExpectEntities, reader gotransit.Reader) {
