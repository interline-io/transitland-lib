...
-- Note: stop_times is partitioned, so we need to add columns to each partition

-- Add columns to parent table
...
-- Add columns to each partition
ALTER TABLE public.gtfs_stop_times_0
    ADD COLUMN start_pickup_drop_off_window integer,
    ADD COLUMN end_pickup_drop_off_window integer,
    ADD COLUMN pickup_booking_rule_id bigint,
    ADD COLUMN drop_off_booking_rule_id bigint,
...
ALTER TABLE public.gtfs_stop_times_1
    ADD COLUMN start_pickup_drop_off_window integer,
    ADD COLUMN end_pickup_drop_off_window integer,
    ADD COLUMN pickup_booking_rule_id bigint,
    ADD COLUMN drop_off_booking_rule_id bigint,
...
ALTER TABLE public.gtfs_stop_times_2
    ADD COLUMN start_pickup_drop_off_window integer,
    ADD COLUMN end_pickup_drop_off_window integer,
    ADD COLUMN pickup_booking_rule_id bigint,
    ADD COLUMN drop_off_booking_rule_id bigint,
...
ALTER TABLE public.gtfs_stop_times_3
    ADD COLUMN start_pickup_drop_off_window integer,
    ADD COLUMN end_pickup_drop_off_window integer,
    ADD COLUMN pickup_booking_rule_id bigint,
    ADD COLUMN drop_off_booking_rule_id bigint,
...
ALTER TABLE public.gtfs_stop_times_4
    ADD COLUMN start_pickup_drop_off_window integer,
    ADD COLUMN end_pickup_drop_off_window integer,
    ADD COLUMN pickup_booking_rule_id bigint,
    ADD COLUMN drop_off_booking_rule_id bigint,
...
ALTER TABLE public.gtfs_stop_times_5
    ADD COLUMN start_pickup_drop_off_window integer,
    ADD COLUMN end_pickup_drop_off_window integer,
    ADD COLUMN pickup_booking_rule_id bigint,
    ADD COLUMN drop_off_booking_rule_id bigint,
...
ALTER TABLE public.gtfs_stop_times_6
    ADD COLUMN start_pickup_drop_off_window integer,
    ADD COLUMN end_pickup_drop_off_window integer,
    ADD COLUMN pickup_booking_rule_id bigint,
    ADD COLUMN drop_off_booking_rule_id bigint,
...
ALTER TABLE public.gtfs_stop_times_7
    ADD COLUMN start_pickup_drop_off_window integer,
    ADD COLUMN end_pickup_drop_off_window integer,
    ADD COLUMN pickup_booking_rule_id bigint,
    ADD COLUMN drop_off_booking_rule_id bigint,
...
ALTER TABLE public.gtfs_stop_times_8
    ADD COLUMN start_pickup_drop_off_window integer,
    ADD COLUMN end_pickup_drop_off_window integer,
    ADD COLUMN pickup_booking_rule_id bigint,
    ADD COLUMN drop_off_booking_rule_id bigint,
...
ALTER TABLE public.gtfs_stop_times_9
    ADD COLUMN start_pickup_drop_off_window integer,
    ADD COLUMN end_pickup_drop_off_window integer,
    ADD COLUMN pickup_booking_rule_id bigint,
    ADD COLUMN drop_off_booking_rule_id bigint,
