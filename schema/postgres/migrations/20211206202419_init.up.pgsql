CREATE EXTENSION postgis IF NOT EXISTS postgis;
CREATE EXTENSION hstore IF NOT EXISTS hstore;
CREATE EXTENSION pg_trgm IF NOT EXISTS pg_trgm;
CREATE EXTENSION unaccent IF NOT EXISTS unaccent;
CREATE TEXT SEARCH CONFIGURATION tl ( COPY = simple ); ALTER TEXT SEARCH CONFIGURATION tl ALTER MAPPING FOR hword, hword_part, word WITH unaccent;
