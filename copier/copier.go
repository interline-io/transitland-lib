...
func (copier *Copier) checkEntity(ent tt.Entity) (string, error) {
	...
	// cause's to state because only the cause knows whether the value it
	// describes leaves the entity usable; a cause that says nothing is an error,
	// so this defaults to the previous behavior.
