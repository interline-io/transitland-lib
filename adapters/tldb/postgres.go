...
func init() {
	// Register driver
	dbAdapters["postgres"] = func(dburl string) Adapter { return &PostgresAdapter{DBURL: dburl} }
	dbAdapters["postgresql"] = func(dburl string) Adapter { return &PostgresAdapter{DBURL: dburl} }
