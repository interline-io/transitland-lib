...
type Stop struct {
	...
	ParentStation      string  `db:"parent_station" csv:"parent_station" gorm:"type:int;index"`
	...
	Geometry           *Point  `db:"geometry" gorm:"column:geometry;type:geography(POINT, 4326);not null"`
	BaseEntity
}
